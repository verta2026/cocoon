...
class ForgeSummaryFormatTest(unittest.TestCase):
    def test_event_timestamp_and_speaker_use_injected_names(self):
        ...
        self.assertEqual(event_speaker(event, user_name="Leta"), "Leta")
        self.assertEqual(event_speaker(assistant("reply"), assistant_name="Bound"), "Bound")
